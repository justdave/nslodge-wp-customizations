...
function nslodge_ue_do_cvs_export() {
    ...
    header('Expires: 0');
    header('Cache-Control: must-revalidate, post-check=0, pre-check=0');
    echo '"Election Date","Chapter Name","Unit Type","Unit Number","First Name","Middle Name","Last Name","Suffix","BSA Person ID","Home Email Address","Home Phone","Address Line 1","Address Line 2","City","State","Zip Code","Date Of Birth"' . "\n";
    $candidate_columnlist = [
        'ElectionDate',
        'ChapterName',
        'UnitType',
